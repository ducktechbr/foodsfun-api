...
exports.routes.post('/newOrder', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title_1, info_1, quantity_1, tableId_1, orderTable, userId, tables, orders, map, error_13;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = req.body.data, title_1 = _a.title, info_1 = _a.info, quantity_1 = _a.quantity, tableId_1 = _a.tableId;
            ...
            case 2:
                ...
                Promise.allSettled(map).then(function (results) {
                    ...
                    var createdOrder = prisma_1.prisma.orders
                        .create({ data: data })
